...
summary: Our new paper on one-step generative modeling from scratch using Score-of-Mixture 
  Training (SMT) accepted as a Spotlight Poster (top 2.6%) at ICML 2025!
title: Score-of-Mixture Training accepted as Spotlight Poster (top 2.6%) at ICML 2025
links:
  - icon_pack: fas
    icon: file-pdf
    name: Poster
...
---
Our new paper "Score-of-Mixture Training: One-Step Generative Model Training Made Simple via Score Estimation of Mixture Distributions" has been accepted as a **Spotlight Poster (top 2.6%)** at the 42nd International Conference on Machine Learning (ICML 2025). This is joint work with Jongha (Jon) Ryu and Gregory W. Wornell. Please refer to the links above for more information.  In this work we propose a new 
